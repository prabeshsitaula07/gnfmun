...
export default function Description() {
    return (
        <div className="flex flex-col lg:flex-row justify-between px-12 h-screen pt-12">
            <div className="flex gap-4 flex-col lg:flex-row">
                <img src={student1} alt="student1" className="self-end h-[400px]" />
                <img src={student1} alt="student2" className="self-start h-80" />
            </div>
