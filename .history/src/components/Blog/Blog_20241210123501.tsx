...
const Blog: React.FC = () => (
  <>
    ...
    <div className="relative text-white mx-14 h-[477px]">
      <img src={blogimg} profile alt="blog" className="w-full h-full object-cover rounded-[20px]" />
    ...
    <div className="px-10 py-16">
      <h2 className="font-semibold text-3xl text-gray-900 mb-12 text-center">Latest Blog Posts</h2>
      <div className="flex flex-wrap gap-8 justify-center">
        <BlogCard
          imgSrc={profile}
          title="5 Tips for Better Job Hunting"
          author="John Doe"
          date="June 10, 2024"
          profileImg={profile}
        />
