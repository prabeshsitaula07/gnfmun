...
const Blog: React.FC = () => (
    <>
        <div className="relative text-white mx-12 h-[477px]">
                    ...
                    {[
                        {
                            ...
                            author: { name: "Holden Caulfield", role: "UI DEVELOPER", img: "https://www.un.org/sites/un2.un.org/files/styles/banner-image-style-27-10/public/2020/10/real_un_briefing.jpg" },
                            comments: "1.2K",
                            likes: "6"
                        },
                        {
                            ...
                            description: "Live-edge letterpress cliche, salvia fanny pack humblebrag narwhal portland...",
                            author: { name: "Alper Kamu", role: "DESIGNER", img: "https://www.un.org/sites/un2.un.org/files/styles/3x2-front-thumbnail/public/field/image/model_un_landing_page.jpg" },
                            comments: "1.2K",
                            likes: "6"
                        }
                    ].map((blog, index) => (
