    ...
    <div class="flex flex-wrap -m-12">
      ...
      <div class="p-12 md:w-1/2 flex flex-col items-start">
        ...
        <div class="flex items-center flex-wrap pb-4 mb-4 border-b-2 border-gray-100 mt-auto w-full">
          ...
          <span class="text-gray-400 inline-flex items-center ml-auto text-sm">
            <svg class="w-4 h-4 mr-1" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none">
              <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
              <circle cx="12" cy="12" r="3"></circle>
            </svg>1.2K
          </span>
        ...
        <a class="inline-flex items-center">
          <img alt="blog" src="https://dummyimage.com/104x104" class="w-12 h-12 rounded-full object-cover object-center">
