    ...
    >
        ...
        >
            ...
            <div className="absolute bottom-20 px-12 rounded-lg">
                ...
                <button className="mt-6 px-6 py-3 bg-primary font-semibold text-white rounded-lg hover:bg-white hover:ring-primary hover:ring-1 hover:text-primary transition duration">
                    Get Started
                </button>
            </div>
        </div>
