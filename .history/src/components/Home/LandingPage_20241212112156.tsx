    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-20 px-12 rounded-lg">
                ...
                <button className="btn relative inline-flex items-center justify-start overflow-hidden font-medium transition-all bg-indigo-100 rounded hover:bg-white group py-2 px-2">
