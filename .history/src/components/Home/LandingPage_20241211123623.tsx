    ...
    return (
        ...
        >
            <div className="absolute bottom-6 px-12 rounded-lg">
                ...
                <button className="mt-6 px-6 py-3 font-semibold hover:bg-primary text-white rounded-lg hover:bg-white hover:ring-primary hover:ring-2 hover:text-primary">
                    Get Started
                </button>
            </div>
        </div>
