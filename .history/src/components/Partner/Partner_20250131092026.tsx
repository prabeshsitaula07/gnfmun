...
export default function Partner() {
    return (
        <div className='flex p-12 gap-6 justify-between'>
            {/* Left side: Images */}
            <div className='flex h-full gap-4 min-w-fit bg-red-100'>
                <img src={partner2} alt="Partner 2" className='self-end border h-80' />
                <img src={partner1} alt="Partner 1" className='self-start h-[500px] w-[450px] border' />
            </div>

            {/* Right side: Text */}
            <div className='flex flex-col justify-between'>
                <h2 className="text-6xl font-normal">Meet the partners<br/> who help us<br/> transform lives</h2>
                <p className="text-lg">
