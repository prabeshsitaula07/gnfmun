...
export default function Partner() {
    return (
        <div className='flex p-12 items-stretch gap-6'>
            {/* Left side: Images */}
            <div className='flex h-full w-1/2 gap-4'>
                <img src={partner2} alt="Partner 2" className='self-end border' />
                <img src={partner1} alt="Partner 1" className='self-start h-[70vh] border w-fit' />
            </div>

            {/* Right side: Text */}
            <div className='w-1/2 flex flex-col justify-center'>
                <h2 className="text-2xl font-bold">Meet the partners who help us transform lives</h2>
                <p className="text-lg">
