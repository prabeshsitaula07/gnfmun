    ...
    <div className="min-h-fit py-20 bg-blue-50 flex items-center text-center flex-col gap-10 justify-center">
      <h1 className="text-6xl">Connect with Us</h1>
        <div className="text-xl text-gray-600 flex flex-col gap-2">
            ...
            <span className="flex items-center gap-4 justify-center"><FaPhoneAlt />9851064446</span>
            <span className="flex items-center gap-4 justify-center"><IoMail />greatnepalfoundation@gmail.com</span>
        </div>
