...
const Navbar: React.FC = () => {
  ...
  return (
    <header className="w-full fixed top-0 z-50">
      ...
      {!isScrolled && (
        <div className="bg-primary text-white py-2 px-12 text-sm flex justify-between items-center">
          <div>
      ...
      >
        <div className="container mx-auto flex justify-between items-center">
          ...
          >
            <li>
              <Link href="#" className="block md:inline-block px-4 py-2 hover:text-blue-600">Home</Link>
            </li>
            <li>
              <Link href="#" className="block md:inline-block px-4 py-2 hover:text-blue-600">About</Link>
            </li>
            <li>
              <Link href="#" className="block md:inline-block px-4 py-2 hover:text-blue-600">Services</Link>
            </li>
            <li>
              <Link href="#" className="block md:inline-block px-4 py-2 hover:text-blue-600">Contact</Link>
            </li>
          </ul>
