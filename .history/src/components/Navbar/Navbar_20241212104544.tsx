    ...
    return (
        <header
            className={`fixed w-full z-50 transition-transform duration-300 ${
                isScrolled ? "bg-white shadow-md translate-y-0" : "bg-transparent"
            }`}
        >
            {/* Contact Info */}
            <div
                className={`fixed top-0 left-0 w-full bg-primary px-6 py-3 text-center text-sm transition-transform duration-300 ${
            ...
            {/* Navbar */}
            <nav className="flex justify-between items-center px-4 py-4 md:px-14">
