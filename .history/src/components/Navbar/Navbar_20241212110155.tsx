    ...
    <header className="w-full fixed top-0 z-50">
      ...
      >
        <div className="container mx-auto flex justify-between items-center">
          ...
          >
            <li>
              <Link ="#" className="block md:inline-block px-4 py-2 hover:text-red">Home</Link>
            </li>
            <li>
              <Link ="#" className="block md:inline-block px-4 py-2 hover:text-red">About</Link>
            </li>
            <li>
              <Link ="#" className="block md:inline-block px-4 py-2 hover:text-red">Services</Link>
            </li>
            <li>
              <Link ="#" className="block md:inline-block px-4 py-2 hover:text-red">Contact</Link>
            </li>
          </ul>
