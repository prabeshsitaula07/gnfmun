    ...
    return (
        <header className="px-6 md:px-14 my-10 fixed w-full bg-white z-50">
            ...
            >
                ...
                <span className="flex items-center"><FaPhoneAlt className="mr-2" /> +123 456 7890</span>|<span className="flex items-center"><FaEnvelope className="mr-2" /> info@example.com</span>
                </div>
            </div>
