...
const Navbar = () => {
    ...
    return (
        <header className="px-6 md:px-14 my-10 fixed w-full bg-white z-50">
            ...
            {/* Contact Info */}
            <div
                className={`fixed top-0 w-full bg-primary py-2 px-4 flex justify-between items-center transition-transform duration-300 ${isScrolled ? "translate-y-0" : "-translate-y-full"
                    }`}
            >
