...
const Navbar = () => {
    ...
    return (
        <header className="px-6 md:px-14 my-10 fixed w-full bg-white z-50">
            ...
            {/* Contact Info */}
            <div
                className={`ffixed top-0 w-full bg-black bg-opacity-50 py-2 px-4 flex justify-between items-center transition-transform duration-300 ${isScrolled ? "translate-y-0" : "-translate-y-full"
                    }`}
            >
