        ...
        <header className="border-b border-gray-30">
            <nav className="flex justify-between items-center px-6 py-4">
                ...
                >
                    ...
                    ></span>
                    <span
                        className={`block w-6 h-1 bg-white my-1 transition-opacity ${isMenuOpen ? "opacity-0" : ""
                            }`}
                    ></span>
                    <span
                        className={`block w-6 h-1 bg-white transition-transform ${isMenuOpen ? "-rotate-45 -translate-y-2" : ""
                            }`}
                    ></span>
                </div>
            </nav>
