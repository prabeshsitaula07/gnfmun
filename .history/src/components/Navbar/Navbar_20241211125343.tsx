...
const Navbar = () => {
    ...
    return (
        <header className="px-6 md:px-14 my-10 fixed w-full bg-white z-50">
            ...
            >
                <div className="flex items-center justify-center  className="text-white font-semibold"">
                <span className="text-white font-semibold">Call us: +123 456 7890</span>|<span>Email: info@example.com</span>
                </div>
            </div>
