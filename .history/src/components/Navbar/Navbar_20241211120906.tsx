    ...
    return (
        <header className="px-6 md:px-14 my-10 fixed w-full bg-white z-50">
            ...
            <nav className="flex justify-between items-center border border-gray-30 mt-1 px-4">
                ...
                {/* Navbar Links */}
                <ul
                    className={`flex flex-col md:flex-row md:static md:space-x-8 md:w-auto items-center md:transform-none transition-transform duration-300 font-primaryfont font-bold text- ${isMenuOpen
