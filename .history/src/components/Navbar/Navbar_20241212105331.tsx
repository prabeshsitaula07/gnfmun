    ...
    <header className="w-full fixed top-0 z-50">
      ...
      >
        <div className="container mx-auto flex justify-between items-center">
          {/* Logo */}
          <div className="text-2xl font-bold text-blue-600 block">MyLogo</div>

          {/* Navigation Links */}
          <ul
            className={`md:flex space-x-6 text-gray-700 font-medium ${
              isMenuOpen ? "block" : "hidden"
            } md:block absolute md:static bg-white w-full md:w-auto left-0 top-full md:top-auto md:translate-x-0 transition-all duration-300`}
          >
            <li>
