...
const Navbar = () => {
    ...
    return (
        <header className="px-6 md:px-14 my-10 fixed w-full bg-white z-50">
            {/* Contact Info */}
            <div
                className={`fixed top-0 left-0 w-full bg-gray-100 px-6 py-2 text-center text-sm transition-transform duration-300 ${isScrolled ? "translate-y-0" : "-translate-y-full"
                    }`}
            >
