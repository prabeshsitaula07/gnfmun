    ...
    <header className="w-full fixed top-0 z-50">
      ...
      >
        <div className="container mx-auto flex justify-between items-center">
          ...
          >
            <li>
              <Link href="#" className="block md:inline-block px-4 py-2 hover:text-blue-600">Home</a>
            </li>
            <li>
              <Link href="#" className="block md:inline-block px-4 py-2 hover:text-blue-600">About</a>
            </li>
            <li>
              <Link href="#" className="block md:inline-block px-4 py-2 hover:text-blue-600">Services</a>
            </li>
            <li>
              <Link href="#" className="block md:inline-block px-4 py-2 hover:text-blue-600">Contact</a>
            </li>
          </ul>
