    ...
    <header className="w-full fixed top-0 z-50">
      ...
      >
        <div className="container mx-auto flex justify-between items-center">
          ...
          >
            <li>
              <a href="#" className="block md:inline-block px-4 py-2">Home</a>
            </li>
            <li>
              <a href="#" className="block md:inline-block px-4 py-2">About</a>
            </li>
            <li>
              <a href="#" className="block md:inline-block px-4 py-2">Services</a>
            </li>
            <li>
              <a href="#" className="block md:inline-block px-4 py-2">Contact</a>
            </li>
          </ul>
