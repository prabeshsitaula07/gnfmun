  ...
  return (
    <div className="pr-12 bg-blue-50 h-fit flex justify-between">
      ...
      <div className='w-1/2'>
        ...
        <div className='pt-10 text-xl font-medium text-gray-500'>
        ...
        <div className='py-10 text-xl font-medium text-gray-500'>
        ...
        <span className='font-bold text-gray-700'>- Shawn G., volunteer educator since 2012</span>
        </div>
      </div>
    </div>
  )
