  ...
  return (
    <div className="flex justify-between px-12 pt-12">
      ...
      <button className="btn relative inline-flex items-center justify-start overflow-hidden font-medium transition-all bg-indigo-100 rounded hover:bg-white group py-2 px-2 my-4 ring-1 ring-primary">
                    ...
                    <span className="relative w-full text-left inline-flex items-center gap-4 text-primary transition-colors duration-300 ease-in-out group-hover:text-white text-lg">Sponsor a child today <FaArrowRightLong/></span>
                </button>
    </div>
  )
}
