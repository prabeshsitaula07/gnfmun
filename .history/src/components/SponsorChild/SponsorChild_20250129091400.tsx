...
export default function SponsorChild() {
  return (
    <div className="flex justify-between px-12 py-2">
      ...
      <button className="btn relative items-center justify-start overflow-hidden font-medium transition-all bg-indigo-100 rounded hover:bg-white group py-2 px-2 my-4 ring-1 ring-primary flex">
